...
import CharactherDetailsModal from "../../common/CharactherDetailsModal/CharactherDetailsModal"
            ...
            <div className='container mx-auto  py-10 px-2 md:px-0'>
                ...
                <div className='max-w-5xl mx-auto' >
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 py-10'>
                        <CharactherCard onClick={() => setOpen(true)} title="Nessa" description="The Fractured Soul" image={charImg1} height={150} />
                        <CharactherCard onClick={() => setOpen(true)} title="Kael" description="The Shadow Walker" image={charImg2} height={150} />
