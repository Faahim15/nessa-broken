  ...
  return (
    <div className="bg-[#0C0E0F] py-10 px-2 md:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-10">
          <div className="space-y-5 ">
            <Image
              ...
              width={500}
              alt="logo"
              className="h-19 w-34.5 "
            />
            <div className="space-y-2 text-white">
              <p className="text-[16px]">
                A fractured reality where identity, lss, and my interwine in
                stores of profound emotion.
              </p>
              <p className="text-[#9D9A97] text-[14px]">
          ...
          <div className="space-y-5">
            ...
            <p className="text-[#9D9A97] text-[14px]">
              Subscribe to receive updates about new releases. character
              insight, and exclusive content
            </p>
          ...
          <div className="space-y-5">
            ...
            {/* Social Media logo */}
            <div className="flex items-center gap-5 text-[#9D9A97]!">
              <div className="border-[#4F4F59] border p-2 rounded-xl cursor-pointer">
                <LuFacebook size={25} />
              </div>
              <div className="border-[#4F4F59] border p-2 rounded-xl cursor-pointer">
                <FiTwitter size={25} />
      ...
      <div className="container mx-auto mt-5 flex flex-col md:flex-row justify-between gap-4 items-center">
        <div>
          <p className="text-xs md:text-sm text-[#9D9A97]">
            © 2026 The City Of Feather Fields. All rights reserved.
          </p>
        </div>
