...
const BlogCard: React.FC<{ post: BlogPost }> = ({ post }) => {
  return (
    <article className="bg-[#131417] rounded-lg overflow-hidden hover:transform hover:scale-[101%] transition-all duration-300 lg:mx-5">
      ...
      <div className="p-6">
        ...
        <h2 className="text-2xl font-bold text-white mb-3 hover:text-white/70 transition-colors font-inter">
          {post.title}
        </h2>
